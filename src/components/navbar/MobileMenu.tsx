...
const MobileMenu = ({ isOpen, onClose }: MobileMenuProps) => {
  ...
  return (
    <div 
      className={`md:hidden fixed top-[3.5rem] sm:top-[4rem] left-0 w-full transition-all duration-300 ease-in-out overflow-x-hidden ${
        isOpen 
    ...
    >
      <div className="mx-auto max-w-screen-xl px-3 sm:px-4">
        <div className="bg-black/95 backdrop-blur-lg border-b border-white/10 rounded-lg">
