      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        <div className="text-center space-y-8">
          ...
          <div className="flex justify-center gap-4">
            <button className="group relative px-8 py-3 bg-[#3f80f6] text-white font-semibold rounded-full overflow-hidden hover:bg-[#3f80f6]/90 transition-all duration-300">
            ...
            <button className="px-8 py-3 border-2 border-[#3f80f6] bg-[#3f80f6] text-white font-semibold rounded-full hover:bg-[#3f80f6]/90 transition-colors duration-200">
              Watch Demo
            </button>
          </div>
        </div>
