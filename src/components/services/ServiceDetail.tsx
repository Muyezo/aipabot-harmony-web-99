    ...
    >
      ...
      >
        <div className="relative">
          <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-24 max-w-[100vw] md:max-w-7xl">
            <ServiceDetailHeader
              title={service.title}
            ...
            <motion.div 
              ...
              className="text-center mt-8 sm:mt-12 mb-12 sm:mb-16 px-2 sm:px-4"
            >
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4">
                {getServiceTitle()}
              </h2>
              <p className="text-base sm:text-lg lg:text-xl text-gray-200 max-w-4xl mx-auto">
                {getServiceSubtext()}
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 px-2 sm:px-4">
